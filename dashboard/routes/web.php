...
use App\Http\Controllers\AutoMailController;
use App\Http\Controllers\ProfileController;
use App\Http\Controllers\AppUserController;
use App\Http\Controllers\InboxController;
use App\Http\Controllers\ReportController;
use App\Http\Controllers\TaskController;
use App\Http\Controllers\AutoMailService;
...
Route::get('/import-form', [AutoMailService::class, 'importForm'])->name('import.form');
Route::post('/import', [AutoMailService::class, 'import'])->name('import');
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('dashboard/setting',[SettingsController::class,'index'])
        ->name('settings.index');

    Route::get('dashboard/automail',[AutoMailController::class,'index'])
        ->name('automail.index');

    Route::post('dashboard/import',[AutoMailController::class,'import'])
        ->name('automail.import');

    Route::post('dashboard/mailTemplateTesting',[AutoMailController::class,'mailTemplateTesting'])
        ->name('automail.mailTemplateTesting');

    Route::post('dashboard/updateTemplate',[AutoMailController::class,'updateTemplate'])
        ->name('automail.updateTemplate');
});
