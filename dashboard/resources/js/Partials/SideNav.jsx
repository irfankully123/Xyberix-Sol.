        ...
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            <div className="app-brand demo">
                <a href="https://www.xyberixsolutions.com/" className="app-brand-link">
                    ...
                    <span className="mx-1">Xyberix</span>
                </a>
            ...
            <ul className="menu-inner py-1">
                ...
                <li className={url.startsWith('/dashboard/automail') ? 'menu-item active' : 'menu-item'}>
                    <Link href={route('automail.index')} className="menu-link">
